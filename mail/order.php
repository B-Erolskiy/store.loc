...
<div class="wrapper fixed__footer">
    ...
    <div class="ht__bradcaump__area" style="background: #e5e6da;">
                                    ...
                                    <tr>
                                        <td class="product-thumbnail">
                                            <a href="<?=\yii\helpers\Url::to(['product/view', 'id' => $item['id']]); ?>">
                                                <?php /*$message->embed(Yii::getAlias('@web/images/product/big-img/' .
                                                    $item['img'], ['alt' => $item['name'], 'title' => $item['name']])) */?>
                                            </a>
                                        </td>
                                        <td class="product-name"><a href="<?=\yii\helpers\Url::to(['product/view', 'id' => $item['id']]); ?>"><?=$item['name']?></a></td>
