...
<div class="wrapper">
    ...
    <div class="my-tabs ptb--30">
            <input type="radio" name="tab-btn" id="tab-btn-1" value="" checked>
            <label for="tab-btn-1"> <span class="ti-shopping-cart"></span><br>Корзина</label>
        <div style="border-top: 2px dotted #ddd;display: inline-block; width: 10%;"></div>
            <?php if (empty($session['cart'])): ?>
                <input type="radio" class="disabled" disabled="true" name="tab-btn" id="tab-btn-2" value="">
                <label for="tab-btn-2"><span class="ti-package"></span><br>Оформление заказа</label>
            <?php else:?>
            ...
            <?php if (!empty($session['cart'])) :?>
                <div id="orderForm" class="container">
                    <div class="col-md-12 col-sm-12 col-xs-12" id="form">
                        <h2 class="bradcaump-title ptb--20">Форма оформления заказа</h2>
                        <br>
